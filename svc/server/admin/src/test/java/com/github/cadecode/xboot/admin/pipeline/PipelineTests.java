...
import com.github.cadecode.xboot.admin.config.PipelineTestProperties;
...
@TestPropertySource(properties = {
        "pipeline-test.filter-selectors.BIZ1=PipelineTestFilterA,PipelineTestFilterB,PipelineTestFilterC",
        "pipeline-test.filter-selectors.BIZ2=PipelineTestFilterB,PipelineTestFilterC",
        "pipeline-test.filter-selectors.BIZ3=PipelineTestFilterA",
        "pipeline-test.filter-selectors.BIZ4=on",
        "pipeline-test.filter-selectors.BIZ5=off",
})
public class PipelineTests {
    ...
    @Autowired
    private PipelineTestProperties props;
    ...
    private FilterSelector createSelector(PipelineTestType type) {
        return FilterSelectorFactory.createFilterSelector(type.getType(), props.getFilterSelectors());
    }
    ...
    void testDeclarative_on() {
        FilterSelector selector = createSelector(PipelineTestType.BIZ4);
    ...
    void testDeclarative_off() {
        FilterSelector selector = createSelector(PipelineTestType.BIZ5);
    ...
    void testDeclarative_unconfigured() {
        assertThrows(ExtensionException.class,
                () -> createSelector(PipelineTestType.UNKNOWN));
    }
