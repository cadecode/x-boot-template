package com.github.cadecode.uniboot.starter.web.advisor;

import cn.hutool.core.util.ObjUtil;
import com.github.cadecode.uniboot.common.exception.GeneralException;
import com.github.cadecode.uniboot.common.util.JacksonUtil;
import com.github.cadecode.uniboot.starter.web.annotation.ApiFormat;
import com.github.cadecode.uniboot.starter.web.enums.WebErrorEnum;
import com.github.cadecode.uniboot.starter.web.model.ApiResult;
...
public class ApiResultAdvisor implements ResponseBodyAdvice<Object> {
    ...
    /**
     * 根据 ApiFormat 注解判断是否需要包装成 ApiResult
     *
    ...
    private Object apiResultFormat(MethodParameter returnType, Object body, ServerHttpResponse response) {
        ...
        if (ObjUtil.isNull(body)) {
            throw GeneralException.of(WebErrorEnum.RES_BODY_NULL, "");
        }
