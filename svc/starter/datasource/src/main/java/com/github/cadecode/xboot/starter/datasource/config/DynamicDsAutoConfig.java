package com.github.cadecode.xboot.starter.datasource.config;

import com.github.cadecode.xboot.starter.datasource.dynamic.DynamicDs;
import com.github.cadecode.xboot.starter.datasource.dynamic.DynamicDsHolder;
import com.github.cadecode.xboot.starter.datasource.exception.DynamicDsException;
...
@ConditionalOnProperty(name = "x-boot.dynamic-ds.enable", havingValue = "true")
