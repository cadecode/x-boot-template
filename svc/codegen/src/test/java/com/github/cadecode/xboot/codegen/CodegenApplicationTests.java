package com.github.cadecode.xboot.codegen;

import com.github.cadecode.xboot.codegen.util.DbDocKit;
import com.github.cadecode.xboot.codegen.util.GenCodeKit;
...
public class CodegenApplicationTests {
    ...
    public void genCode() {
        String outputDir = ".";
        String basePackage = "com.github.cadecode.xboot.codegen.test";
