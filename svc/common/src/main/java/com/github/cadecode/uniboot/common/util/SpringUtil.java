package com.github.cadecode.uniboot.common.util;

import cn.hutool.core.util.ArrayUtil;
import com.fasterxml.jackson.core.type.TypeReference;
import com.github.cadecode.uniboot.common.exception.HelperException;
...
public class SpringUtil implements BeanFactoryPostProcessor, ApplicationContextAware {
    ...
    public static ConfigurableListableBeanFactory getConfigurableBeanFactory() {
        ...
        if (null != BEAN_FACTORY) {
            ...
            throw new HelperException("no listable bean factory");
        }
        return factory;
    }
    ...
    public static void unregisterBean(String beanName) {
        ...
        if (factory instanceof DefaultSingletonBeanRegistry registry) {
            ...
            throw new HelperException("can not unregister bean, bean name is {}", beanName);
        }
    }
